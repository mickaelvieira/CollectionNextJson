...
class ErrorSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('CollectionNextJson\Entity\Error');
        $this->shouldBeAnInstanceOf('CollectionJson\Entity\Error');
        $this->shouldImplement('CollectionNextJson\MessageAware');
        $this->shouldImplement('JsonSerializable');
    }

    /**
     * @param \CollectionNextJson\Entity\Message $message
     */
    function it_should_be_chainable($message)
    {
        $this->setCode('value')->shouldHaveType('CollectionNextJson\Entity\Error');
        $this->setMessage('value')->shouldHaveType('CollectionNextJson\Entity\Error');
        $this->setTitle('value')->shouldHaveType('CollectionNextJson\Entity\Error');
        $this->addMessage($message)->shouldHaveType('CollectionNextJson\Entity\Error');
        $this->addMessageSet([$message])->shouldHaveType('CollectionNextJson\Entity\Error');
    }
    ...
    /**
     * @param \CollectionNextJson\Entity\Message $message1
     */
