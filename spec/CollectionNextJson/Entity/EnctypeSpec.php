...
class EnctypeSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('CollectionNextJson\Entity\Enctype');
    ...
    {
        $this->addOption([])->shouldHaveType('CollectionNextJson\Entity\Enctype');
        $this->addOptionSet([])->shouldHaveType('CollectionNextJson\Entity\Enctype');
    }
