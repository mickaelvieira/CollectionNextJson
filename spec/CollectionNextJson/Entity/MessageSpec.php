...
class MessageSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('CollectionNextJson\Entity\Message');
    ...
    {
        $this->setCode('value')->shouldHaveType('CollectionNextJson\Entity\Message');
        $this->setMessage('value')->shouldHaveType('CollectionNextJson\Entity\Message');
        $this->setName('value')->shouldHaveType('CollectionNextJson\Entity\Message');
    }
