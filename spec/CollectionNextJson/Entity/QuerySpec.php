...
class QuerySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('CollectionNextJson\Entity\Query');
        $this->shouldBeAnInstanceOf('CollectionJson\Entity\Query');
        $this->shouldImplement('JsonSerializable');
    }

    function it_should_be_chainable()
    {
        $this->setHref('value')->shouldHaveType('CollectionNextJson\Entity\Query');
        $this->setRel('value')->shouldHaveType('CollectionNextJson\Entity\Query');
        $this->setName('value')->shouldHaveType('CollectionNextJson\Entity\Query');
        $this->setPrompt('value')->shouldHaveType('CollectionNextJson\Entity\Query');
        $this->addData([])->shouldHaveType('CollectionNextJson\Entity\Query');
        $this->addDataSet([])->shouldHaveType('CollectionNextJson\Entity\Query');
    }
