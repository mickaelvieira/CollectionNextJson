...
class DataSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('JsonCollectionNext\Entity\Data');
        $this->shouldBeAnInstanceOf('JsonCollection\Entity\Data');
    ...
    {
        $this->setName('value')->shouldHaveType('JsonCollectionNext\Entity\Data');
        $this->setPrompt('value')->shouldHaveType('JsonCollectionNext\Entity\Data');
        $this->setValue('value')->shouldHaveType('JsonCollectionNext\Entity\Data');
        $this->setType('value')->shouldHaveType('JsonCollectionNext\Entity\Data');
        $this->setRequired('value')->shouldHaveType('JsonCollectionNext\Entity\Data');
        $this->setList($list)->shouldHaveType('JsonCollectionNext\Entity\Data');
        $this->addOptionToList([])->shouldHaveType('JsonCollectionNext\Entity\Data');
        $this->addOptionsToList([])->shouldHaveType('JsonCollectionNext\Entity\Data');
    }
    ...
    function it_should_add_an_option_to_the_list_when_it_is_passed_as_an_array()
    {
        ...
        $this->getList()->shouldHaveType('JsonCollectionNext\Entity\ListData');
