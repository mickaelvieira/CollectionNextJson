...
class MethodSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('JsonCollectionNext\Entity\Method');
    ...
    {
        $this->addOption([])->shouldHaveType('JsonCollectionNext\Entity\Method');
        $this->addOptionSet([])->shouldHaveType('JsonCollectionNext\Entity\Method');
    }
