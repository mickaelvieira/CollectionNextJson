...
class StatusSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('JsonCollectionNext\Entity\Status');
    ...
    {
        $this->setCode('value')->shouldHaveType('JsonCollectionNext\Entity\Status');
        $this->setMessage('value')->shouldHaveType('JsonCollectionNext\Entity\Status');
    }
