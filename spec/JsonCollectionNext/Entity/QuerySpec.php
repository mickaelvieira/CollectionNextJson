...
class QuerySpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('JsonCollectionNext\Entity\Query');
        $this->shouldBeAnInstanceOf('JsonCollection\Entity\Query');
        $this->shouldImplement('JsonSerializable');
    }

    function it_should_be_chainable()
    {
        $this->setHref('value')->shouldHaveType('JsonCollectionNext\Entity\Query');
        $this->setRel('value')->shouldHaveType('JsonCollectionNext\Entity\Query');
        $this->setName('value')->shouldHaveType('JsonCollectionNext\Entity\Query');
        $this->setPrompt('value')->shouldHaveType('JsonCollectionNext\Entity\Query');
        $this->addData([])->shouldHaveType('JsonCollectionNext\Entity\Query');
        $this->addDataSet([])->shouldHaveType('JsonCollectionNext\Entity\Query');
    }
