...
class LinkSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('JsonCollectionNext\Entity\Link');
        $this->shouldBeAnInstanceOf('JsonCollection\Entity\Link');
        $this->shouldImplement('JsonSerializable');
    }

    function it_should_be_chainable()
    {
        $this->setHref('value')->shouldHaveType('JsonCollectionNext\Entity\Link');
        $this->setRel('value')->shouldHaveType('JsonCollectionNext\Entity\Link');
        $this->setType('value')->shouldHaveType('JsonCollectionNext\Entity\Link');
        $this->setName('value')->shouldHaveType('JsonCollectionNext\Entity\Link');
        $this->setPrompt('value')->shouldHaveType('JsonCollectionNext\Entity\Link');
        $this->setRender('value')->shouldHaveType('JsonCollectionNext\Entity\Link');
    }
