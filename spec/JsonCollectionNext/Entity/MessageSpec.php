...
class MessageSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('JsonCollectionNext\Entity\Message');
    ...
    {
        $this->setCode('value')->shouldHaveType('JsonCollectionNext\Entity\Message');
        $this->setMessage('value')->shouldHaveType('JsonCollectionNext\Entity\Message');
        $this->setName('value')->shouldHaveType('JsonCollectionNext\Entity\Message');
    }
