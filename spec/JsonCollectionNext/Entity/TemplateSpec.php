...
class TemplateSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('JsonCollectionNext\Entity\Template');
        $this->shouldBeAnInstanceOf('JsonCollection\Entity\Template');
    ...
    {
        $this->setMethod($method)->shouldHaveType('JsonCollectionNext\Entity\Template');
        $this->setEnctype($enctype)->shouldHaveType('JsonCollectionNext\Entity\Template');
        $this->addData([])->shouldHaveType('JsonCollectionNext\Entity\Template');
        $this->addDataSet([])->shouldHaveType('JsonCollectionNext\Entity\Template');
    }
    ...
    /**
     * @param \JsonCollectionNext\Entity\Data $data
     */
    ...
    /**
     * @param \JsonCollectionNext\Entity\Data $data1
     * @param \JsonCollectionNext\Entity\Data $data2
     */
    ...
    {
        $this->getMethod()->shouldHaveType('JsonCollectionNext\Entity\Method');
    }

    function it_should_return_a_enctype_entity()
    {
        $this->getEnctype()->shouldHaveType('JsonCollectionNext\Entity\Enctype');
    }
}
