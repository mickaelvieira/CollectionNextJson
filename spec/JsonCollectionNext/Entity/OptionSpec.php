...
class OptionSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('JsonCollectionNext\Entity\Option');
    ...
    {
        $this->setPrompt('value')->shouldHaveType('JsonCollectionNext\Entity\Option');
        $this->setValue('value')->shouldHaveType('JsonCollectionNext\Entity\Option');
    }
