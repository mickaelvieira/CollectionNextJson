...
class ItemSpec extends ObjectBehavior
{
    ...
    {
        $this->shouldHaveType('JsonCollectionNext\Entity\Item');
        $this->shouldBeAnInstanceOf('JsonCollection\Entity\Item');
        $this->shouldImplement('JsonSerializable');
    }

    function it_should_be_chainable()
    {
        $this->setHref('value')->shouldHaveType('JsonCollectionNext\Entity\Item');
        $this->addLink([])->shouldHaveType('JsonCollectionNext\Entity\Item');
        $this->addLinkSet([])->shouldHaveType('JsonCollectionNext\Entity\Item');
        $this->addData([])->shouldHaveType('JsonCollectionNext\Entity\Item');
        $this->addDataSet([])->shouldHaveType('JsonCollectionNext\Entity\Item');
    }
